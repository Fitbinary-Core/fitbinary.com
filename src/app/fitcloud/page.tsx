        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <motion.div
              ...
              whileInView="whileInView"
              viewport={{ once: true }}
              className="bg-white rounded-[40px] shadow-[0_20px_60px_-15px_rgba(37,99,235,0.1)] border border-blue-50 relative overflow-hidden p-12 lg:p-16 h-125 flex items-center justify-center"
            >
