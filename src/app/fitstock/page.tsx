        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              whileInView="whileInView"
              viewport={{ once: true }}
              className="order-2 lg:order-1 bg-white rounded-[40px] shadow-[0_20px_60px_-15px_rgba(220,38,38,0.1)] border border-red-50 relative overflow-hidden p-12 lg:p-16 h-[500px] flex items-center justify-center"
            >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="h-28 bg-white rounded-2xl shadow-sm border border-gray-100"
                      />
                    ))}
                  </div>
                  <div className="w-full h-32 bg-white rounded-2xl shadow-sm border border-gray-100" />
                </div>
              </div>
            </motion.div>
            <motion.div
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center">
          <div className="bg-red-600 rounded-[3rem] py-24 px-6 relative overflow-hidden group shadow-[0_20px_60px_-15px_rgba(220,38,38,0.4)]">
            ...
            <Link
              href="https://fitstock.fitbinary.com"
              className="inline-flex items-center gap-2 px-10 py-5 bg-white text-red-600 rounded-full font-bold text-lg hover:bg-gray-50 transition-all shadow-2xl relative z-10 active:scale-95 group-hover:gap-3"
            >
              Launch FitStock
